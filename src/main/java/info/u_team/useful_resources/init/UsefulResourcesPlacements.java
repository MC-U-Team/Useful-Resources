...
import info.u_team.useful_resources.placement.EndIslandsPlacement;
...
public class UsefulResourcesPlacements {
	...
	public static final RegistryObject<EndIslandsPlacement> ONLY_END_ISLANDS = PLACEMENTS.register("only_end_islands", EndIslandsPlacement::new);
