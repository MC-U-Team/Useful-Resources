...
import static info.u_team.useful_resources.api.ResourceRegistry.register;
...
public class Resources {
	...
	public static final IResource COPPER = register(new BasicIngotResource("copper", 0xFFFFFF, Rarity.COMMON, 1, 3) //
