...
public class TestToolMaterial implements IToolMaterial {
	...
	public TestToolMaterial(int[] additionalDamage, float[] speed, int harvestlevel, int durability, float efficiency, float baseDamage, int enchantability, Supplier<Ingredient> ingredient) {
