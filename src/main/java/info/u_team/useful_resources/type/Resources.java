...
public class Resources {
	...
	public static final Resource COPPER = register(new Builder("copper", 3F, 1).setArmor(new UArmorMaterialVanilla(5, new int[] { 2, 3, 4, 3 }, 20, SoundEvents.AMBIENT_CAVE, 1, () -> Ingredient.fromItems(Items.ACACIA_LEAVES))).setTools(new UToolMaterial(new int[] { 5, 1, 0, 1, 3 }, new float[] { 10, 2, 3, 1, 4 }, 2, 10, 30, 8, 20, () -> Ingredient.fromItems(Items.ACACIA_LEAVES))).setGeneration(ORE, createRangeOverworld(9, 20, 0, 0, 64)).setGeneration(NETHER_ORE, createRangeNether(9, 10, 10, 20, 128)));
